 ...
 * @author ASUS
 */
public class FDataKembali extends javax.swing.JFrame {
    ...
    Object header[] = {"ID PEMINJAM", "ID ANGGOTA", "ID BUKU", "TANGGAL KEMBALI"};
    DefaultTableModel data = new DefaultTableModel(null, header);
    TabelKembali.setModel(data);
    ...
    private void IDPeminjamOtomatis(){
        try {
            Connection kon = koneksi.koneksiDb();
            Statement st=kon.createStatement();
            String sql_id="SELECT * FROM tbl_kembali ORDER BY id_peminjam desc";
...
//    
    ...
    try {
        ...
        String sql = "INSERT INTO tbl_kembali (id_peminjam, id_anggota, id_buku, tanggal_kembali) VALUES ('" 
                + IDPeminjam.getText() + "','" 
                + IDAnggota.getSelectedItem() + "','" 
                + IDBuku.getSelectedItem() + "','" 
                + TanggalKembali.getText() + "')";
        st.execute(sql);
        JOptionPane.showMessageDialog(null, "Data Pengembalian Berhasil Diinputkan");
    } catch (Exception e) {
        JOptionPane.showMessageDialog(null, e);
    }
}
...
//    
    ...
    try {
        Connection kon = koneksi.koneksiDb();
        Statement st = kon.createStatement();
        String sql_peminjam = "SELECT nama FROM tbl_anggota WHERE id_anggota='" + IDAnggota.getSelectedItem().toString() + "'";
        ResultSet rs = st.executeQuery(sql_peminjam);
        while (rs.next()) {
            NamaPeminjam.setText(rs.getString("nama"));
        }
    } catch (Exception e) {
...
//    Load ID Buku
    public void LoadBuku(){
        try{
            ...
            while(rs.next()){
                IDBuku.addItem(rs.getString("id_buku"));
            }
            rs.close();
        }
        catch(Exception e) {
    ...
    try {
        Connection kon = koneksi.koneksiDb();
        Statement st = kon.createStatement();
        String sql_buku = "SELECT judul FROM tbl_buku WHERE id_buku='" + IDBuku.getSelectedItem().toString() + "'";
        ResultSet rs = st.executeQuery(sql_buku);
        while (rs.next()) {
    ...
    public void clear(){
        IDPeminjam.setText("");
        IDAnggota.setSelectedItem("A00001");
        NamaPeminjam.setText("");
        IDBuku.setSelectedItem("B00001");
        JudulBuku.setText("");
...
//    Edit Data
    public void update(){
        try {
            ...
            String sql_update="UPDATE tbl_kembali SET id_anggota='"+IDAnggota.getSelectedItem()
                    +"',id_buku='"+IDBuku.getSelectedItem()
    ...
    private void delete(){
        try{
            Connection kon = koneksi.koneksiDb();
            Statement st=kon.createStatement();
            String sql_delete="DELETE FROM tbl_kembali WHERE id_peminjam='"+IDPeminjam.getText()+"'";
    ...
    private void initComponents() {
        ...
        IDBuku = new javax.swing.JComboBox<>();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(IDAnggota, 0, 160, Short.MAX_VALUE)
                            .addComponent(NamaPeminjam)
                            .addComponent(IDBuku, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void BKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BKeluarActionPerformed
        ...
        keluar=JOptionPane.showOptionDialog(this,
                "Keluar dari Kelola Data Pengembalian",
    ...
    private void BInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BInputActionPerformed
        // TODO add your handling code here:
        int simpan=JOptionPane.showOptionDialog(this, "Apakah Data Pengembalian Sudah Benar?", "Simpan Data", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE,null,null,null);
    ...
    private void BEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BEditActionPerformed
        // TODO add your handling code here:
        int update=JOptionPane.showOptionDialog(this, "Apakah Data Pengembalian Sudah Benar?", "Update Data", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE,null,null,null);
    ...
    private void BDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BDeleteActionPerformed
        // TODO add your handling code here:
        int delete=JOptionPane.showOptionDialog(this, "Apakah Yakin Ingin Hapus Data Pengembalian?", "Hapus Data", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE,null,null,null);
    ...
    private void TabelKembaliMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelKembaliMouseClicked
        // TODO add your handling code here:
        int bar=TabelKembali.getSelectedRow();
        String a=TabelKembali.getValueAt(bar, 0).toString();
        String b=TabelKembali.getValueAt(bar, 1).toString();
        String c=TabelKembali.getValueAt(bar, 2).toString();
        String d=TabelKembali.getValueAt(bar, 3).toString();
        
        IDPeminjam.setText(a);
        IDAnggota.setSelectedItem(b);
        IDBuku.setSelectedItem(c);
        TanggalKembali.setText(d);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FDataKembali.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FDataKembali().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> IDBuku;
